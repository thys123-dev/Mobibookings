    ...
    <div className="space-y-6">
      ...
      {Array.from({ length: attendeeCount }).map((_, index) => {
          ...
          const displayPrice = useMemo(() => {
              ...
              if (!selectedAddOnTreatment && attendeeData?.fluidOption === '1000ml_dextrose') {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
              ...
              />
                  ...
                  {selectedTreatment && !selectedAddOnTreatment && (
                    <FormField
                      control={form.control}
                          ...
                          >
                            ...
                            <SelectContent>
                              ...
                              {treatmentsList.map((treatment) => (
                                <SelectItem key={treatment.id} value={String(treatment.id)}>
                                  {treatment.name} - R{treatment.price}
                                </SelectItem>
                              ))}
                            </SelectContent>
                          </Select>
      ...
      <div className="mt-6 pt-4 border-t">
          <p className="text-lg font-semibold text-right">Total Estimated Cost: R {calculatedTotalCost.toFixed(2)}</p>
          </div>
